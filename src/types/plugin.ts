...
export interface FieldsSettings {
  ...
  firstRead: FieldConfig;
  lastRead: FieldConfig; // enabling firstRead/lastRead will create both start/end properties in the frontmatter
  rereads: FieldConfig;
}
...
export const DEFAULT_FIELDS_SETTINGS: FieldsSettings = {
  ...
  firstRead: { enabled: true, propertyName: "firstRead" },
  lastRead: { enabled: true, propertyName: "lastRead" },
